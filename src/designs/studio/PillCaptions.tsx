// "studio" captions (Elements: captions/moving-pill-captions): a brand-blue
// pill slides from word to word as Daniel says them. Adapted: Be Vietnam Pro
// (Montserrat's latin subset has no Vietnamese), the core's sentence-aware
// captionPages, and page times already on the talk timeline.
